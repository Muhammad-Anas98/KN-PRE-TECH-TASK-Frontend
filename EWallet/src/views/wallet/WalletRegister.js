                      ...
                      <CFormGroup row>
                        ...
                        <CCol md="3">
                          <CSelect custom name="currency" value={this.state.currency} onChange={this.inputChangeHandler} id="currency-input">
                            <option value="USDOLLAR_$">USD $</option>
                            <option value="CANADIANDOLLAR_CA$">CAD $</option>
                            <option value="AUSTRALIANDOLLAR_A$">AUD $</option>
                            <option value="STERLINGPOUND_£">GBP £</option>
